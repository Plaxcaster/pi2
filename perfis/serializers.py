...
class PerfilSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Perfilfields = ('id', 'nome', 'email','nome_empresa','senha','contatos')
		read_only_fields = ('id',)
	...
	def create(self, validated_data):
		try:
			...
			raise exceptions.ParseError('Já existe um usuário com esse nome', code=status.HTTP_400_BAD_REQUEST)
